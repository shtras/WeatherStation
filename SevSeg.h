 ...
 * Copyright 2020 Jens Breidenstein (SevSegShift part)
 *
...
public:
    ...
    void refreshDisplay();
    void begin(uint8_t hardwareConfig, uint8_t numDigitsIn, bool resOnSegmentsIn = 0, bool updateWithDelaysIn = 0,
...
protected:
    ...
    virtual void segmentOn(uint8_t segmentNum) = 0;
    virtual void segmentOff(uint8_t segmentNum) = 0;
    virtual void digitOn(uint8_t digitNum) = 0;
    virtual void digitOff(uint8_t digitNum) = 0;
