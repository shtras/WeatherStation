...
static const int32_t powersOf10[] = {1,                                      // 10^0
    10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000}; // 10^9

static const int32_t powersOf16[] = {0x1,                           // 16^0
...
void SevSeg::begin(uint8_t hardwareConfig, uint8_t numDigitsIn, bool resOnSegmentsIn,
...
void SevSeg::setNumber(int32_t numToShow, int8_t decPlaces, bool hex)
{ //int32_t
...
void SevSeg::setNumberF(float numToShow, int8_t decPlaces, bool hex)
{ //float
